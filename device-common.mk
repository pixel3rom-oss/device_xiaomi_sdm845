...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/a2dp_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/a2dp_audio_policy_configuration.xml \
    $(LOCAL_PATH)/usb_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/usb_audio_policy_configuration.xml \
    $(LOCAL_PATH)/r_submix_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/r_submix_audio_policy_configuration.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/init.leds.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.leds.sh \
    $(LOCAL_PATH)/init.msm.usb.configfs.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.msm.usb.configfs.rc \
    $(LOCAL_PATH)/init.panel_info.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.panel_info.sh \
    ...
    $(LOCAL_PATH)/init.recovery.qcom.rc:$(TARGET_ROOT_OUT)/init.recovery.qcom.rc \
